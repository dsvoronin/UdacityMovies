...
/**
 * https://raw.githubusercontent.com/JakeWharton/u2020/master/src/main/java/com/jakewharton/u2020/ui/misc/BindableAdapter.java
...
public abstract class BindableAdapter<T> extends BaseAdapter {
    ...
    @Override
    public final View getView(int position, View view, @NonNull ViewGroup container) {
        if (view == null) {
